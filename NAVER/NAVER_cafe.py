...
def naver_scrap():
    try:
        ...
        #TOP FACTORY 도서리뷰 게시판
        driver.get("https://cafe.naver.com/topfact?iframe_url=/ArticleList.nhn%3Fsearch.clubid=25169767%26search.menuid=28%26search.boardtype=L%26search.questionTab=A%26search.totalCount=106%26search.page=1")
